...
import { MOOD_SPRITE, FUN_SPRITES } from '@/lib/spriteConfig';
...
function spriteUrl(filename: string): string { return `/sprites/${filename}`; }
...
export function useCreatureAnimation(
  ...
  return { spritePath: spriteUrl(file), flip };
}
